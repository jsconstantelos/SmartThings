 ...
 */
metadata {
	definition (name: "My Aeon Metering Switch", namespace: "jsconstantelos", author: "SmartThings", ocfDeviceType: "oic.d.switch", mnmn: "SmartThings", vid:"generic-switch-power-energy") {
		...
		fingerprint mfr: "0086", prod: "0003", model: "0060", deviceJoinName: "Aeotec Smart Switch 6"
    ...
    preferences {
        ...
        input "debugOutput", "boolean", title: "Enable debug logging?", defaultValue: true, displayDuringSetup: true
        ...
        input "wattsChanged", "number", title: "For ReportType = 1, Don't send unless watts have changed by this many watts: (range 0 - 32,000W)", defaultValue: 1, range: "0..32000", required: false, displayDuringSetup: true
        input "wattsPercent", "number", title: "For ReportType = 1, Don't send unless watts have changed by this percent: (range 0 - 99%)", defaultValue: 1, range: "0..99", required: false, displayDuringSetup: true
        input "secondsWatts", "number", title: "For ReportType = 0, Send Watts data every how many seconds? (range 0 - 65,000 seconds)", defaultValue: 60, range: "0..65000", required: false, displayDuringSetup: true
