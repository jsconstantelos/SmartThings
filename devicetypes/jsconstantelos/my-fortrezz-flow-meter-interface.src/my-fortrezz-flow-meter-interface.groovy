 ...
 */
metadata {
	definition (name: "My FortrezZ Flow Meter Interface", namespace: "jsconstantelos", author: "Daniel Kurin", vid: "generic-switch-power-energy", ocfDeviceType: "oic.d.switch", genericHandler: "Z-Wave") {
		capability "Battery"
