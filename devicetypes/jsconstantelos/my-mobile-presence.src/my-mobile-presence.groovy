...
metadata {
	definition (name: "My Mobile Presence", namespace: "jsconstantelos", author: "SmartThings", ocfDeviceType: "x.com.st.d.mobile.presence") {
...
def off() {
	log.debug "Fixing precence to not present"
    sendEvent(name:"presence", value: "not present", displayed: false)
    sendEvent(name:"switch", value: "off", displayed: false)
}

def on() {
	log.debug "Fixing precence to present"
