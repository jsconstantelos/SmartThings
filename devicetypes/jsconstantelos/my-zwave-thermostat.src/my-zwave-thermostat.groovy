...
metadata {
	...
	definition (name: "My ZWave Thermostat", ocfDeviceType: "oic.d.thermostat", namespace: "jsconstantelos", author: "SmartThings", mnmn: "SmartThings", vid:"SmartThings-smartthings-Z-Wave_Thermostat")
    { 
		capability "Refresh"
		capability "Actuator"
