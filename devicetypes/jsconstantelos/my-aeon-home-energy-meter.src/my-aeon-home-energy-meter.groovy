 ...
 */
metadata {
	definition (name: "My Aeon Home Energy Meter", namespace: "jsconstantelos", author: "jsconstantelos", vid: "generic-switch-power-energy", ocfDeviceType: "oic.d.switch", genericHandler: "Z-Wave") {
