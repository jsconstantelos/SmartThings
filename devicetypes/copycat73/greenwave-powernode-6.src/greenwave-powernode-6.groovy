...
def configure() {
    ...
    cmds << zwave.configurationV1.configurationSet(configurationValue: [1], parameterNumber: 2, size: 1).format()	// power on relay after power failuer 0=all off, 1=remember last state, 2=all on
