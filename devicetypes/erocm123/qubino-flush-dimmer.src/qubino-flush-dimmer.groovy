...
metadata {
	...
	tiles{
        ...
        valueTile("presetThree", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "presetThree", label:'Preset 3', action:"presetThree"
        }
        valueTile("presetFour", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "presetFour", label:'Preset 4', action:"presetFour"
        }        
        valueTile("presetUpFive", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "presetUpFive", label:'5%', action:"presetUpFive", icon:"st.thermostat.thermostat-up"
        }
		valueTile("presetDownFive", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "presetDownFive", label:'5%', action:"presetDownFive", icon:"st.thermostat.thermostat-down"
        }
